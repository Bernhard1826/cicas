...
%
% Build on Overleaf (IEEEtran.cls and IEEEtran.bst are provided by the system;
% do NOT ship a local IEEEtran.cls --- an empty one shadows the built-in class):
...
% algpseudocode, and amsthm/bbm/booktabs/multirow/dblfloatfix added there).
\input{packages}

% IEEE: restore multiline-equation page breaks (amsmath sets this to 10000).
\interdisplaylinepenalty=2500

% Extra float slots --- this paper has many full-width table*/algorithm* floats.
\extrafloats{64}

\pagestyle{plain}   % show page numbers (NDSS submission)
