...
\textbf{Layer~A, description provenance.} Description is an IR field. When Layer~2 of DLEP
(\S\ref{sec:method-dual-layer}) parses a normative sentence, it stores that
...
must be stressed. \CodeEqIR{} only shows that the code follows the IR, which is
not the same as code--normative-rule
