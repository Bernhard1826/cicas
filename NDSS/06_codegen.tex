...
be logically correct. To contain both kinds of uncertainty, we confine
...
atomic template carries which IR predicate'' and ``whether the IR's subject and
constraint can both be filled into the chosen atomic template'' still require
...
predefined rules. Here ``derive'' means constructing a DSL tree from the IR step by
