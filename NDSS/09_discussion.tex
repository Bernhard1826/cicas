...
jointly satisfy three conditions: (1) they express mandatory/recommended
levels with recognizable formal deontic keywords; (2) the constrained
target is a structured, machine-parsable artifact (certificate, protocol
message, configuration file); and (3) they have a hierarchical section
...
For specification authors, three drafting principles reduce extraction
...
pattern. For lint maintainers, we suggest writing the description
...
emitted set, 9 have specification text from CABF BR yet are already
implemented by existing RFC~5280 lints in zlint. A rule-by-rule check
