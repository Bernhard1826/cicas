...
candidate zlint lints, then compare field by field, giving a three-level verdict full (fully implemented) /
...
and coverage counts only full (Stage-4; partial/none go to $\phi_G$).
