...
ground truth, we propose the Stage-Aware Iterative Verification (SAIV) framework.
...
computed by a reverse coverage check---running the coverage judge over
the not-lintable set $\RU$ and counting the normative rules it rates full or partial; each
