...
\S\ref{subsec:repair}.
\textsc{RouteRepair} in Algorithm~\ref{alg:saiv} is this deterministic routing
step: it maps the residual and lintability-check signals to one repair operation
in $\{\mathcal{P}_R,\mathcal{P}_L,\mathcal{P}_G,\mathcal{P}_V\}$.
